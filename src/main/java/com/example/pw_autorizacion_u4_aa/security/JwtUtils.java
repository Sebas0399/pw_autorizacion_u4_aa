...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication, String name,String jwtSecret,Long jwtExpiration ) {
    ...
    public String generateJwtToken(String name,String jwtSecret,Long jwtExpiration ) {
        LOG.info("Semilla: " + jwtSecret);
        LOG.info("Tiempo: " + jwtExpiration);

        return Jwts.builder().
                setIssuedAt(new Date()).setSubject(name).
                setExpiration(new Date(System.currentTimeMillis() + jwtExpiration)).
                signWith(SignatureAlgorithm.HS512, jwtSecret).compact();
    }
}
